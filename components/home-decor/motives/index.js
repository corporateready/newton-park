...
import motive_1 from "../../../public/static/motives/sisteme-ingineresti-01.webp";
import motive_2 from "../../../public/static/motives/supermarket.webp";
import motive_3 from "../../../public/static/motives/livrare-01.webp";
import motive_4 from "../../../public/static/motives/open-space-homedecor.webp";
import motive_5 from "../../../public/static/motives/intrare.webp";
import motive_6 from "../../../public/static/motives/motive_4.webp";
      ...
      >
        <div className={styles.container}>
          <h2 className={styles.title}>
            De ce unicul spațiu pretabil pentru home decor
          ...
          <div className={styles.inner}>
            ...
            <div className={styles.motive}>
              <div className={styles.motive__wrapper}>
                <div className={styles.motive__image}>
                  <Image  className={styles.motive__image_body} src={motive_5} width={321} height={86} priority alt="motive" />
                </div>
            ...
            <div className={styles.motive}>
              <div className={styles.motive__wrapper}>
                <div className={styles.motive__image}>
                  <Image src={motive_4} width={321} height={229} priority alt="motive" />
                </div>
                <div className={styles.motive__title_wrapper}>
                  <h3 className={styles.motive__title}>
                  Open space
            ...
            <div className={styles.motive}>
              <div className={styles.motive__wrapper}>
                ...
                <div className={styles.motive__title_wrapper}>
                  <h3 className={styles.motive__title}>
                  Prezența unui Supermarket în 
                  <br/>același complex comercial
                  </h3>
                </div>
              </div>
            </div>
