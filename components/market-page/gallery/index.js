          ...
          <div className={styles.gallery__wrapper}>
            ...
            <div className={styles.gallery__inner}>
              ...
              <Swiper
                ...
                <SwiperSlide>
                  <Image src={image_1_webp} alt={'slide parter scheme 1'} priority />
                </SwiperSlide>

                <SwiperSlide>
                  <div className={styles.slide__image_wrapper}>
                    <Image src={image_2_webp} alt={'slide parter scheme 2'} priority />
                  </div>
                </SwiperSlide>
              </Swiper>
              <button
                type="button"
                // disabled={navigationNextRef}
