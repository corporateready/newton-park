        ...
        <div className={styles.container}>
          ...
          <div className={styles.inner}>
            ...
            <div className={styles.motive}>
              <div className={styles.motive__wrapper}>
                <div className={styles.motive__image}>
                  <Image src={motive_5} width={321} height={170} priority alt="motive" />
                </div>
            ...
            <div className={styles.motive}>
              <div className={styles.motive__wrapper}>
                <div className={styles.motive__image}>
                  <Image src={motive_4} width={321} height={201} priority alt="motive" />
                </div>
                <div className={styles.motive__title_wrapper}>
                  <h3 className={styles.motive__title}>
            ...
            <div className={styles.motive}>
              <div className={styles.motive__wrapper}>
                <div className={styles.motive__image}>
                  <Image src={motive_3} width={321} height={204} priority alt="motive" />
                </div>
                <div className={styles.motive__title_wrapper}>
                  <h3 className={styles.motive__title}>
                    Open space
            ...
            <div className={styles.motive}>
              <div className={styles.motive__wrapper}>
                <div className={styles.motive__image}>
                  <Image src={motive_6} width={321} height={234} priority alt="motive" />
                </div>
                <div className={styles.motive__title_wrapper}>
                  <h3 className={styles.motive__title}>
                    Sisteme inginerești
            ...
            <div className={styles.motive}>
              <div className={styles.motive__wrapper}>
                <div className={styles.motive__image}>
                  <Image src={motive_1} width={301} height={164} priority alt="motive" />
                </div>
                <div className={styles.motive__title_wrapper}>
                  <h3 className={styles.motive__title}>
